...
CA_UTILITIES = {
    "los angeles": {"name": "LADWP", "full_name": "Los Angeles Department of Water and Power", "net_metering_max_kw": 30, "rate_per_kwh": 0.10},
    "sherman oaks": {"name": "LADWP", "full_name": "Los Angeles Department of Water and Power", "net_metering_max_kw": 30, "rate_per_kwh": 0.10},
    "encino": {"name": "LADWP", "full_name": "Los Angeles Department of Water and Power", "net_metering_max_kw": 30, "rate_per_kwh": 0.10},
    "van nuys": {"name": "LADWP", "full_name": "Los Angeles Department of Water and Power", "net_metering_max_kw": 30, "rate_per_kwh": 0.10},
    "north hollywood": {"name": "LADWP", "full_name": "Los Angeles Department of Water and Power", "net_metering_max_kw": 30, "rate_per_kwh": 0.10},
    "pasadena": {"name": "SCE", "full_name": "Southern California Edison", "net_metering_max_kw": 25, "rate_per_kwh": 0.12},
    "glendale": {"name": "GWP", "full_name": "Glendale Water & Power", "net_metering_max_kw": 25, "rate_per_kwh": 0.11},
    "san diego": {"name": "SDG&E", "full_name": "San Diego Gas & Electric", "net_metering_max_kw": 25, "rate_per_kwh": 0.14},
    "san francisco": {"name": "PG&E", "full_name": "Pacific Gas and Electric", "net_metering_max_kw": 25, "rate_per_kwh": 0.13},
    "sacramento": {"name": "SMUD", "full_name": "Sacramento Municipal Utility District", "net_metering_max_kw": 25, "rate_per_kwh": 0.09},
    # Default for unrecognized California cities
    "_default": {"name": "SCE", "full_name": "Southern California Edison", "net_metering_max_kw": 25, "rate_per_kwh": 0.12},
}
...
class NECCaliforniaEngine(NECBaseEngine):
    ...
    _LA_NEIGHBORHOODS = {
        "encino", "sherman oaks", "van nuys", "north hollywood", "studio city",
        "tarzana", "woodland hills", "canoga park", "chatsworth", "reseda",
        "northridge", "granada hills", "winnetka", "west hills", "porter ranch",
        "sylmar", "sun valley", "arleta", "pacoima", "mission hills",
        "panorama city", "north hills", "lake balboa", "valley village",
        "toluca lake", "burbank adjacent", "los feliz", "silver lake",
        "echo park", "atwater village", "glassell park", "mount washington",
        "highland park", "eagle rock", "elysian valley", "cypress park",
        "west adams", "leimert park", "hyde park", "crenshaw", "mid-city",
        "palms", "mar vista", "del rey", "playa del rey", "westchester",
        "playa vista", "venice", "marina del rey adjacent", "brentwood",
        "westwood", "sawtelle", "century city", "cheviot hills", "rancho park",
        "culver city adjacent", "south los angeles", "watts", "willowbrook",
        "central-alameda", "boyle heights", "lincoln heights",
        "el sereno", "city terrace", "east los angeles adjacent",
        "northeast los angeles", "sunland", "tujunga", "shadow hills",
        "hansen hills", "lakeview terrace", "kagel canyon",
    }
